  ...
  return (
    <div className="min-h-screen bg-paper font-sans antialiased text-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-4 pb-12 pt-8 space-y-5">
        {/* 유저 통계 영역 */}
        <section className="bg-white rounded-lg border border-gray-200 p-6 flex flex-col md:flex-row items-center gap-6 justify-between">
          <div>
            <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight">
              <span className="text-navy-600">나</span>의 피드백 통계
            </h2>
          ...
          <div className="flex gap-3">
            <div className="bg-green-50 border border-green-100 px-6 py-4 rounded-lg text-center">
            ...
            <div className="bg-red-50 border border-red-100 px-6 py-4 rounded-lg text-center">
                    ...
                    return (
                      <tr key={log?.timestamp || index} className="border-b border-gray-50 last:border-b-0 hover:bg-gray-50/60 transition-colors">
                        ...
                        <td
                          ...
                          className="px-4 py-4 font-bold text-gray-800 hover:text-navy-600 hover:underline cursor-pointer break-keep text-[14px] transition-colors"
                        >
                          {log?.title || '알 수 없는 기사'}
                        </td>
                        <td className="px-4 py-4 text-center">
